...
function Kbd({ children }: { children: React.ReactNode }) {
  return (
    <kbd className="rounded border px-2 py-0.5 text-xs font-medium">
      {children}
    </kbd>
  );
}
...
export default async function PrivacyPolicyPage() {
  ...
  const { projectName, email, phone, address, city, country, createdAt, updatedAt } =
    PROJECT_DATA;
  ...
  const jsonLd = {
    ...
    description: `${projectName} privacy policy describing how personal data is collected, used, and protected on ${projectName}.`,
    isPartOf: {
      "@type": "WebSite",
      name: projectName,
    },
      ...
      <div className="space-y-10">
        <Section id="intro" title={`About ${projectName}`}>
          <p className="text-secondary-foreground">
            {projectName} operates {projectName}. This Privacy Policy explains
            how we collect, use, disclose, and safeguard information when you
            visit our website or use our services. By accessing or using our
        ...
        <Section id="scope" title="Scope & Acceptance">
          <p className="text-secondary-foreground">
            This Policy applies to our websites, apps, and related services
            (collectively, the "Services"). If you do not agree with this
            Policy, please discontinue use of the Services. Additional notices
            may apply to certain features, vendors, or regions and will be
        ...
        <Section id="data-we-collect" title="Information We Collect">
          <ul className="text-secondary-foreground">
            <li>
              <strong>Information you provide</strong> — e.g., name, email,
              phone, address, passwords, messages, support requests, form
              submissions, and any content you upload.
            </li>
            <li>
              <strong>Automatic data</strong> — e.g., IP address, device
              identifiers, browser type, operating system, locale, referring
              URLs, pages viewed, links clicked, and timestamps.
            </li>
            <li>
              <strong>Cookies & similar tech</strong> — small files like
              cookies, pixels, and local storage used for preferences,
              analytics, security, and personalization. Manage via your browser
              settings.
            </li>
            <li>
              <strong>Third-party data</strong> — where permitted by law, we may
              receive information from partners or public sources to enhance our
              records or prevent fraud.
            </li>
          </ul>
        </Section>
        ...
        <Section id="use-of-data" title="How We Use Information">
          <ul className="text-secondary-foreground">
            ...
            <li>
              Process transactions and fulfill requests (e.g., account creation,
              support).
            </li>
            <li>
            ...
            <li>
              Personalize content and measure performance of features and
            ...
            <li>
              Comply with legal obligations and enforce our terms, policies, and
              agreements.
            </li>
          </ul>
        </Section>
        ...
        <Section id="sharing" title="How We Share Information">
          ...
          <ul className="text-secondary-foreground">
            <li>
              ...
              our behalf for hosting, analytics, communications, payments, or
              support. We require appropriate confidentiality and security
              commitments.
            </li>
            <li>
              <strong>Legal & safety</strong> — to comply with law, respond to
              lawful requests, or protect rights, property, or safety of{" "}
              {projectName}, our users, or the public.
            </li>
            <li>
            ...
            <li>
              <strong>With consent</strong> — where you direct us to share or
        ...
        <Section id="cookies" title="Cookies & Tracking">
          <p className="text-secondary-foreground">
            ...
            keep you signed in, provide security, analyze traffic, and
            personalize content. You can control cookies in your browser
            settings or via available in-product controls. Disabling cookies may
        ...
        <Section id="retention" title="Data Retention">
          <p className="text-secondary-foreground">
            ...
            purposes described in this Policy, to comply with legal obligations,
            resolve disputes, and enforce agreements. Retention periods may vary
            by data type and context.
          </p>
        </Section>
        ...
        <Section id="security" title="Data Security">
          <p className="text-secondary-foreground">
            ...
            designed to protect information. Nonetheless, no method of
        ...
        <Section id="rights" title="Your Rights">
          <p className="text-secondary-foreground">
            ...
            information, and to data portability. You may also object to certain
          ...
          <div className="mt-3 rounded-xl border p-4 text-sm space-y-2">
            ...
            <ul className="list-disc pl-6">
              <li>
                <strong>EEA/UK (GDPR):</strong> You may have additional rights,
                including to lodge a complaint with your local supervisory
                authority.
              </li>
              <li>
                <strong>California (CPRA):</strong> You may have the right to
                know, delete, correct, and opt out of sale/share or targeted
                advertising. We do not sell personal information.
              </li>
              <li>
                <strong>Nigeria (NDPR):</strong> You may request access,
                correction, and erasure, and object to processing under
                applicable law.
              </li>
            </ul>
          </div>
        ...
        <Section id="intl" title="International Data Transfers">
          <p className="text-secondary-foreground">
            If we transfer personal information internationally, we rely on
            appropriate safeguards, such as standard contractual clauses or
            other lawful mechanisms, to protect your information consistent with
            applicable laws.
          </p>
        </Section>
        ...
        <Section id="children" title="Children’s Privacy">
          <p className="text-secondary-foreground">
            Our Services are not directed to children under the age where
            parental consent is required by law. We do not knowingly collect
        ...
        <Section id="do-not-sell" title="Do Not Sell/Share (Opt-Out)">
          <p className="text-secondary-foreground">
            We do not sell personal information. Where applicable law provides
            an opt-out for “sale”, “sharing”, or targeted advertising, you can
